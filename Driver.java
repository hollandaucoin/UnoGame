...
public class Driver {
	public static void main(String[] args) {
		...
		while (discard.getTopCard().getValue().equals("Wild") || discard.getTopCard().getValue().equals("Wild Draw+4")) {
			discard.addCard(d.deal());
		}
		if (discard.getTopCard().getValue().equals("DRAW+2")) {
			...
			p1.pickUpCard(d.deal());
			p1.pickUpCard(d.deal());
			System.out.println("Holland had to pick up 2 cards from the top card dealt, and doesn't get to play.");
			nextPlayer++;
			System.out.println("");
		}
		else if (discard.getTopCard().getValue().equals("SKIP")) {
			System.out.println("Top card: " + discard.getTopCard());
			System.out.println("Holland has been skipped from the top card dealt.");
			nextPlayer++;
			System.out.println("");
		}
		else if (discard.getTopCard().getValue().equals("REVERSE")) {
			System.out.println("Top card: " + discard.getTopCard());
			System.out.println("Since the top card is a reverse, is Halle's turn.");
			nextPlayer++;
			forward = false;
			System.out.println("");
		}
